    ...
    <div className="modal-dialog max-w-2xl">
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title" ><span className="text-accent">NFTWALL</span> Buy & Selling</h5>
          ...
          >
            <div className=" ">
              <h1 className='text-center font-display text-xl 
                      text-jacarta-600  dark:text-white font_40'>1 NFT = <span className="text-accent">$5</span> Bep 20 USDT</h1>
            </div>
          </div>
