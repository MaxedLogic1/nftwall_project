...
import monthlyCollData from '../../assets/json/Monthlycollection'
                ...
                >
                    <figure className="mr-4 shrink-0">
                        <a href="#" className="relative block">
                            <img src={item.img} alt={item.title} className="rounded-2lg" loading="lazy" />
                    ...
                    <div>
                        ...
                        <span className="text-sm dark:text-jacarta-300">{item.rateprice}</span>
                    </div>
                </div>
            ))}
        </div>
        ...
        <>
            ...
            <section className="relative py-24  dark:bg-jacarta-900" id='collection'>
                ...
                <div className="container">
                    ...
                    <div className="mb-8 flex flex-wrap items-center justify-between">
                        <ul className="flex flex-wrap items-center">
                            {['tab1', 'tab2', 'tab3'].map((tab, index) => (
                                <li
                                    key={tab}
                                    className={`my-1 mr-2.5 tab ${activeTab === tab ? "bg-accent text-white" : "bg-white text-jacarta-500"} rounded-lg px-4 py-2 cursor-pointer
                    ...
                    {activeTab === 'tab1' && renderCards(collectionData)}
                    {activeTab === 'tab2' && renderCards(buyNftData)}
                    {activeTab === 'tab3' && renderCards(monthlyCollData)}
